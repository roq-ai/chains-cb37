  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Chains - Your HR Management Solution. Streamlining processes, enhancing efficiency, and elevating employee experience with centralized data management, time tracking, performance evaluation, and engagement tools. Automate for productivity and organizational success."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Chains - Your HR Management Solution. Streamlining processes, enhancing efficiency, and elevating employee experience with centralized data management, time tracking, performance evaluation, and engagement tools. Automate for productivity and organizational success.`}
            </Text>
            <Box
